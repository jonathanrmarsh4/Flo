  ...
  try {
    ...
    if (hkSamples && hkSamples.length > 0) {
      ...
      const hkMetricMap: Record<string, { category: string; displayName: string; unit: string; skipIfExists?: string }> = {
        ...
        'dietaryEnergyConsumed': { category: 'Nutrition', displayName: 'Calories Consumed', unit: 'kcal', skipIfExists: 'calories' },
        'HKQuantityTypeIdentifierDietaryEnergyConsumed': { category: 'Nutrition', displayName: 'Calories Consumed', unit: 'kcal', skipIfExists: 'calories' },
        'dietaryProtein': { category: 'Nutrition', displayName: 'Protein', unit: 'g', skipIfExists: 'protein' },
        'HKQuantityTypeIdentifierDietaryProtein': { category: 'Nutrition', displayName: 'Protein', unit: 'g', skipIfExists: 'protein' },
        'dietaryCarbohydrates': { category: 'Nutrition', displayName: 'Carbohydrates', unit: 'g', skipIfExists: 'carbs' },
        'HKQuantityTypeIdentifierDietaryCarbohydrates': { category: 'Nutrition', displayName: 'Carbohydrates', unit: 'g', skipIfExists: 'carbs' },
        'dietaryFatTotal': { category: 'Nutrition', displayName: 'Total Fat', unit: 'g', skipIfExists: 'fat_total' },
        'HKQuantityTypeIdentifierDietaryFatTotal': { category: 'Nutrition', displayName: 'Total Fat', unit: 'g', skipIfExists: 'fat_total' },
        'dietaryFiber': { category: 'Nutrition', displayName: 'Fiber', unit: 'g', skipIfExists: 'fiber' },
        'HKQuantityTypeIdentifierDietaryFiber': { category: 'Nutrition', displayName: 'Fiber', unit: 'g', skipIfExists: 'fiber' },
        'dietarySugar': { category: 'Nutrition', displayName: 'Sugar', unit: 'g', skipIfExists: 'sugar' },
        'HKQuantityTypeIdentifierDietarySugar': { category: 'Nutrition', displayName: 'Sugar', unit: 'g', skipIfExists: 'sugar' },
        'dietarySodium': { category: 'Nutrition', displayName: 'Sodium', unit: 'mg', skipIfExists: 'sodium' },
        'HKQuantityTypeIdentifierDietarySodium': { category: 'Nutrition', displayName: 'Sodium', unit: 'mg', skipIfExists: 'sodium' },
        'dietaryCaffeine': { category: 'Nutrition', displayName: 'Caffeine', unit: 'mg', skipIfExists: 'caffeine' },
        'HKQuantityTypeIdentifierDietaryCaffeine': { category: 'Nutrition', displayName: 'Caffeine', unit: 'mg', skipIfExists: 'caffeine' },
