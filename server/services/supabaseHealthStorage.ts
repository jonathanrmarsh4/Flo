...
export async function getLatestMetricsWithSources(userId: string): Promise<UserDataMetric[]> {
  ...
  try {
    ...
    // Nutrition - all 38 types now handled via HealthKit samples below
    ...
    if (hkSamples && hkSamples.length > 0) {
      ...
      const hkMetricMap: Record<string, { category: string; displayName: string; unit: string; skipIfExists?: string }> = {
        ...
        'dietaryEnergyConsumed': { category: 'Nutrition', displayName: 'Energy', unit: 'kcal' },
        'HKQuantityTypeIdentifierDietaryEnergyConsumed': { category: 'Nutrition', displayName: 'Energy', unit: 'kcal' },
        ...
        // Nutrition - Fat Types
        'dietaryFatSaturated': { category: 'Nutrition', displayName: 'Saturated Fat', unit: 'g' },
        'HKQuantityTypeIdentifierDietaryFatSaturated': { category: 'Nutrition', displayName: 'Saturated Fat', unit: 'g' },
        'dietaryFatMonounsaturated': { category: 'Nutrition', displayName: 'Monounsaturated Fat', unit: 'g' },
        'HKQuantityTypeIdentifierDietaryFatMonounsaturated': { category: 'Nutrition', displayName: 'Monounsaturated Fat', unit: 'g' },
        'dietaryFatPolyunsaturated': { category: 'Nutrition', displayName: 'Polyunsaturated Fat', unit: 'g' },
        'HKQuantityTypeIdentifierDietaryFatPolyunsaturated': { category: 'Nutrition', displayName: 'Polyunsaturated Fat', unit: 'g' },
        'dietaryCholesterol': { category: 'Nutrition', displayName: 'Cholesterol', unit: 'mg' },
        'HKQuantityTypeIdentifierDietaryCholesterol': { category: 'Nutrition', displayName: 'Cholesterol', unit: 'mg' },
        // Nutrition - Minerals
        ...
        'dietaryPotassium': { category: 'Nutrition', displayName: 'Potassium', unit: 'mg' },
        'HKQuantityTypeIdentifierDietaryPotassium': { category: 'Nutrition', displayName: 'Potassium', unit: 'mg' },
        'dietaryCalcium': { category: 'Nutrition', displayName: 'Calcium', unit: 'mg' },
        'HKQuantityTypeIdentifierDietaryCalcium': { category: 'Nutrition', displayName: 'Calcium', unit: 'mg' },
        'dietaryIron': { category: 'Nutrition', displayName: 'Iron', unit: 'mg' },
        'HKQuantityTypeIdentifierDietaryIron': { category: 'Nutrition', displayName: 'Iron', unit: 'mg' },
        'dietaryMagnesium': { category: 'Nutrition', displayName: 'Magnesium', unit: 'mg' },
        'HKQuantityTypeIdentifierDietaryMagnesium': { category: 'Nutrition', displayName: 'Magnesium', unit: 'mg' },
        'dietaryPhosphorus': { category: 'Nutrition', displayName: 'Phosphorus', unit: 'mg' },
        'HKQuantityTypeIdentifierDietaryPhosphorus': { category: 'Nutrition', displayName: 'Phosphorus', unit: 'mg' },
        'dietaryZinc': { category: 'Nutrition', displayName: 'Zinc', unit: 'mg' },
        'HKQuantityTypeIdentifierDietaryZinc': { category: 'Nutrition', displayName: 'Zinc', unit: 'mg' },
        'dietaryCopper': { category: 'Nutrition', displayName: 'Copper', unit: 'mg' },
        'HKQuantityTypeIdentifierDietaryCopper': { category: 'Nutrition', displayName: 'Copper', unit: 'mg' },
        'dietaryManganese': { category: 'Nutrition', displayName: 'Manganese', unit: 'mg' },
        'HKQuantityTypeIdentifierDietaryManganese': { category: 'Nutrition', displayName: 'Manganese', unit: 'mg' },
        'dietarySelenium': { category: 'Nutrition', displayName: 'Selenium', unit: 'mcg' },
        'HKQuantityTypeIdentifierDietarySelenium': { category: 'Nutrition', displayName: 'Selenium', unit: 'mcg' },
        'dietaryChromium': { category: 'Nutrition', displayName: 'Chromium', unit: 'mcg' },
        'HKQuantityTypeIdentifierDietaryChromium': { category: 'Nutrition', displayName: 'Chromium', unit: 'mcg' },
        'dietaryMolybdenum': { category: 'Nutrition', displayName: 'Molybdenum', unit: 'mcg' },
        'HKQuantityTypeIdentifierDietaryMolybdenum': { category: 'Nutrition', displayName: 'Molybdenum', unit: 'mcg' },
        'dietaryIodine': { category: 'Nutrition', displayName: 'Iodine', unit: 'mcg' },
        'HKQuantityTypeIdentifierDietaryIodine': { category: 'Nutrition', displayName: 'Iodine', unit: 'mcg' },
        'dietaryChloride': { category: 'Nutrition', displayName: 'Chloride', unit: 'mg' },
        'HKQuantityTypeIdentifierDietaryChloride': { category: 'Nutrition', displayName: 'Chloride', unit: 'mg' },
        // Nutrition - Vitamins
        'dietaryVitaminA': { category: 'Nutrition', displayName: 'Vitamin A', unit: 'mcg' },
        'HKQuantityTypeIdentifierDietaryVitaminA': { category: 'Nutrition', displayName: 'Vitamin A', unit: 'mcg' },
        'dietaryVitaminB6': { category: 'Nutrition', displayName: 'Vitamin B6', unit: 'mg' },
        'HKQuantityTypeIdentifierDietaryVitaminB6': { category: 'Nutrition', displayName: 'Vitamin B6', unit: 'mg' },
        'dietaryVitaminB12': { category: 'Nutrition', displayName: 'Vitamin B12', unit: 'mcg' },
        'HKQuantityTypeIdentifierDietaryVitaminB12': { category: 'Nutrition', displayName: 'Vitamin B12', unit: 'mcg' },
        'dietaryVitaminC': { category: 'Nutrition', displayName: 'Vitamin C', unit: 'mg' },
        'HKQuantityTypeIdentifierDietaryVitaminC': { category: 'Nutrition', displayName: 'Vitamin C', unit: 'mg' },
        'dietaryVitaminD': { category: 'Nutrition', displayName: 'Vitamin D', unit: 'mcg' },
        'HKQuantityTypeIdentifierDietaryVitaminD': { category: 'Nutrition', displayName: 'Vitamin D', unit: 'mcg' },
        'dietaryVitaminE': { category: 'Nutrition', displayName: 'Vitamin E', unit: 'mg' },
        'HKQuantityTypeIdentifierDietaryVitaminE': { category: 'Nutrition', displayName: 'Vitamin E', unit: 'mg' },
        'dietaryVitaminK': { category: 'Nutrition', displayName: 'Vitamin K', unit: 'mcg' },
        'HKQuantityTypeIdentifierDietaryVitaminK': { category: 'Nutrition', displayName: 'Vitamin K', unit: 'mcg' },
        'dietaryThiamin': { category: 'Nutrition', displayName: 'Thiamin (B1)', unit: 'mg' },
        'HKQuantityTypeIdentifierDietaryThiamin': { category: 'Nutrition', displayName: 'Thiamin (B1)', unit: 'mg' },
        'dietaryRiboflavin': { category: 'Nutrition', displayName: 'Riboflavin (B2)', unit: 'mg' },
        'HKQuantityTypeIdentifierDietaryRiboflavin': { category: 'Nutrition', displayName: 'Riboflavin (B2)', unit: 'mg' },
        'dietaryNiacin': { category: 'Nutrition', displayName: 'Niacin (B3)', unit: 'mg' },
        'HKQuantityTypeIdentifierDietaryNiacin': { category: 'Nutrition', displayName: 'Niacin (B3)', unit: 'mg' },
        'dietaryFolate': { category: 'Nutrition', displayName: 'Folate', unit: 'mcg' },
        'HKQuantityTypeIdentifierDietaryFolate': { category: 'Nutrition', displayName: 'Folate', unit: 'mcg' },
        'dietaryBiotin': { category: 'Nutrition', displayName: 'Biotin', unit: 'mcg' },
        'HKQuantityTypeIdentifierDietaryBiotin': { category: 'Nutrition', displayName: 'Biotin', unit: 'mcg' },
        'dietaryPantothenicAcid': { category: 'Nutrition', displayName: 'Pantothenic Acid (B5)', unit: 'mg' },
        'HKQuantityTypeIdentifierDietaryPantothenicAcid': { category: 'Nutrition', displayName: 'Pantothenic Acid (B5)', unit: 'mg' },
        // Nutrition - Other
        ...
        'dietaryWater': { category: 'Nutrition', displayName: 'Water', unit: 'L' },
        'HKQuantityTypeIdentifierDietaryWater': { category: 'Nutrition', displayName: 'Water', unit: 'L' },
