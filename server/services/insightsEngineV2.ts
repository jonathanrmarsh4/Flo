...
const METRIC_DOMAIN_MAP: Record<string, MetricDomainWeights> = {
  ...
  'muscle recovery': { primary: 'recovery', secondary: 'performance' },
  'overtraining': { primary: 'recovery', secondary: 'performance' },
  
  // Activity/Performance metrics
  'steps': { primary: 'performance', secondary: 'recovery' },
  'daily steps': { primary: 'performance', secondary: 'recovery' },
  'step count': { primary: 'performance', secondary: 'recovery' },
  ...
  'vo2max': { primary: 'performance', secondary: 'recovery' },
  'workout': { primary: 'performance' },
  'workouts': { primary: 'performance' },
  'workout intensity': { primary: 'performance', secondary: 'recovery' },
  'workout frequency': { primary: 'performance' },
  'training': { primary: 'performance', secondary: 'recovery' },
  'training load': { primary: 'performance', secondary: 'recovery' },
  'activity': { primary: 'performance' },
  'physical activity': { primary: 'performance' },
  'stand hours': { primary: 'performance' },
  'standing hours': { primary: 'performance' },
  'distance': { primary: 'performance' },
  'flights climbed': { primary: 'performance' },
