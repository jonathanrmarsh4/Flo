...
CREATE TABLE IF NOT EXISTS sleep_nights (
  ...
  source VARCHAR(20) DEFAULT 'healthkit' CHECK (source IN ('manual', 'healthkit', 'oura', 'dexcom')),
  oura_session_id TEXT,
...
-- Add skin temperature deviation columns to sleep_nights
DO $$ BEGIN
...
-- Enable RLS and create policies for new Oura tables
