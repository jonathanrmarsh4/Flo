...
- **Apple App Store AI Compliance (Dec 2025):** Full compliance system for sharing health data with third-party AI services:
  - **AIConsentScreen** (`client/src/components/onboarding/AIConsentScreen.tsx`): Onboarding step after security setup that explains AI data sharing with Google AI (Gemini) and OpenAI. Features benefits-first messaging, privacy assurances ("data anonymized", "stored separately"), and enable/skip paths.
  ...
  - **AI Provider Attribution**: "Powered by Google AI" footer in WhyModal and VoiceChatScreen for transparency.
