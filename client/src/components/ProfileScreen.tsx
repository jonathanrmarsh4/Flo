import { User, Calendar, Weight, Ruler, Activity, Moon, Target, Brain, Bell, Shield, FileText, Info, Download, Trash2, ChevronRight, Edit2 } from 'lucide-react';
    ...
    <div className={`h-full overflow-y-auto transition-colors ${
      ...
      <div className="px-4 py-6 space-y-4 pb-24">
        ...
        <div className={`backdrop-blur-xl rounded-3xl border p-6 ${
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <button className={`mt-2 text-xs ${isDark ? 'text-cyan-400' : 'text-cyan-600'}`}>
        ...
        <div className={`text-center text-xs ${isDark ? 'text-white/30' : 'text-gray-400'}`}>
          <div>Flō Health Tracker</div>
          <div>Version 1.0.0 (Build 2025.11)</div>
          <div className="mt-2">Made with ❤️ for longevity</div>
        </div>
      </div>
    </div>
  );
